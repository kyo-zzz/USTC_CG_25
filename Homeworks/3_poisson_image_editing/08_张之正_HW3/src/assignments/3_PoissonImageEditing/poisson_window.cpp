...
void PoissonWindow::draw_toolbar()
{
    if (ImGui::BeginMainMenuBar())
    {
        ...
        // _TODO: You may add more items in the menu for the different types
        ...
        add_tooltips(
            "Press this button and then click in the target image, to perform "
            "seamless cloning of the selected region.");
        // of Poisson editing.
