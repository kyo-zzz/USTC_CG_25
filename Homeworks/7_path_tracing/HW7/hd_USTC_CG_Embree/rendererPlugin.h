...
///
/// \class Hd_USTC_CG_Embree_RendererPlugin
///
...
///
class HD_USTC_CG_EMBREE_API Hd_USTC_CG_Embree_RendererPlugin final : public HdRendererPlugin
{
public:
    Hd_USTC_CG_Embree_RendererPlugin() = default;
    virtual ~Hd_USTC_CG_Embree_RendererPlugin() = default;
...
private:
    ...
    Hd_USTC_CG_Embree_RendererPlugin(const Hd_USTC_CG_Embree_RendererPlugin&) = delete;
    Hd_USTC_CG_Embree_RendererPlugin &operator =(const Hd_USTC_CG_Embree_RendererPlugin&) = delete;
};
