...
bool Integrator::Intersect(const GfRay& ray, SurfaceInteraction& si)
{
    ...
    const Hd_USTC_CG_InstanceContext* instanceContext =
        static_cast<Hd_USTC_CG_InstanceContext*>(rtcGetGeometryUserData(
            rtcGetGeometry(rtc_scene, rayHit.hit.instID[0])));

    const Hd_USTC_CG_PrototypeContext* prototypeContext =
        static_cast<Hd_USTC_CG_PrototypeContext*>(rtcGetGeometryUserData(
