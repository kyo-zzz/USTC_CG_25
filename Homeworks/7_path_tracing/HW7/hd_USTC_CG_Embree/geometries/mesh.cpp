    ...
    bool refined)
{
    ...
    switch (interpolation) {
        case HdInterpolationConstant:
            sampler = new Hd_USTC_CG_ConstantSampler(name, data);
            break;
        case HdInterpolationUniform:
            if (refined) {
                ...
                sampler = new Hd_USTC_CG_UniformSampler(
        ...
        case HdInterpolationVertex:
            if (refined) {
                ...
                sampler = new Hd_USTC_CG_TriangleVertexSampler(
        ...
        case HdInterpolationFaceVarying:
            if (refined) {
                // XXX: Fixme! Hd_USTC_CG_ doesn't currently support
                ...
                sampler = new Hd_USTC_CG_TriangleFaceVaryingSampler(
                    name, data, meshUtil);
            }
            break;
...
{
    return static_cast<Hd_USTC_CG_PrototypeContext*>(
        rtcGetGeometryUserData(_geometry));
}

Hd_USTC_CG_InstanceContext* Hd_USTC_CG_Mesh::_GetInstanceContext(
    RTCScene scene,
    size_t i)
{
    ...
    const TfToken& reprToken)
{
    ...
    // For now, Hd_USTC_CG_Mesh only respects the first desc; this should be
    // fixed.
...
{
    RTCScene scene = static_cast<Hd_USTC_CG_RenderParam*>(renderParam)
                         ->AcquireSceneForEdit();
